...
#class User(models.Model):
    ...
    group_number    = models.CharField(max_length = 15, blank = False, null = False, verbose_name = 'Номер группы')
    room_number     = models.CharField(max_length = 15, blank = True, null = True, verbose_name = 'Номер комнаты')
